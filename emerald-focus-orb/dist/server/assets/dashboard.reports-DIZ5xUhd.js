...
import { Clock, Brain, BarChart2, PlayCircle, Loader2, Calendar, ShieldAlert, FileText } from "lucide-react";
import { useState, useEffect } from "react";
import { b as fetchAllSessions, c as fetchSessionReport, e as endSessionApi } from "./api-CERjnBmU.js";
...
function Reports() {
  ...
  useEffect(() => {
    const timer = setInterval(() => setTimeNow(Date.now()), 1e3);
    return () => clearInterval(timer);
  }, []);
  const handleStopTrackingInReports = async (sessionId) => {
  ...
  const downloadPDF = async (session) => {
    try {
      ...
      const logsHtml = data.focusLogs && data.focusLogs.length > 0 ? data.focusLogs.map((log) => {
        ...
        return `
            ...
            `;
      }).join("") : `<tr><td colspan="3" style="padding: 20px; text-align: center; color: #64748b;">No eye-tracking data captured during this session.</td></tr>`;
  ...
  const avgFocus = completed.length > 0 ? Math.round(completed.reduce((sum, s) => sum + (s.averageFocusScore || 0), 0) / completed.length) : 0;
  ...
  const totalMins = Math.floor(totalMs % (1e3 * 60 * 60) / (1e3 * 60));
  ...
  return /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-4 sm:grid-cols-4", children: [
      /* @__PURE__ */ jsxs("div", { className: "glass-card p-4 flex flex-col justify-between", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between text-xs text-muted-foreground", children: [
          /* @__PURE__ */ jsx("span", { children: "Total Study Time" }),
          /* @__PURE__ */ jsx(Clock, { className: "h-4 w-4 text-accent" })
        ] }),
        /* @__PURE__ */ jsx("div", { className: "mt-3 font-display text-2xl font-bold text-gradient-gold", children: totalStudyTimeStr })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "glass-card p-4 flex flex-col justify-between", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between text-xs text-muted-foreground", children: [
          /* @__PURE__ */ jsx("span", { children: "Average Focus" }),
          /* @__PURE__ */ jsx(Brain, { className: "h-4 w-4 text-primary" })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "mt-3 font-display text-2xl font-bold text-gradient-emerald", children: [
          avgFocus,
          "%"
        ] })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "glass-card p-4 flex flex-col justify-between", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between text-xs text-muted-foreground", children: [
          /* @__PURE__ */ jsx("span", { children: "Total Sessions" }),
          /* @__PURE__ */ jsx(BarChart2, { className: "h-4 w-4 text-accent" })
        ] }),
        /* @__PURE__ */ jsx("div", { className: "mt-3 font-display text-2xl font-bold text-white/90", children: totalSessions })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "glass-card p-4 flex flex-col justify-between", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between text-xs text-muted-foreground", children: [
          /* @__PURE__ */ jsx("span", { children: "Active Sessions" }),
          /* @__PURE__ */ jsx(PlayCircle, { className: "h-4 w-4 text-rose-400 animate-pulse" })
        ] }),
        /* @__PURE__ */ jsx("div", { className: "mt-3 font-display text-2xl font-bold text-gradient-rose", children: activeSessionsCount })
      ] })
    ] }),
    loading ? /* @__PURE__ */ jsxs("div", { className: "flex justify-center py-12 text-muted-foreground", children: [
      /* @__PURE__ */ jsx(Loader2, { className: "mr-2 h-6 w-6 animate-spin" }),
      "Loading sessions..."
    ] }) : sessions.length === 0 ? /* @__PURE__ */ jsx("div", { className: "glass-panel p-8 text-center text-muted-foreground", children: "No focus sessions recorded yet. Start a study session to generate reports!" }) : /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-3", children: sessions.map((s, i) => {
      const dateStr = new Date(s.startTime).toLocaleDateString();
      const durationMs = s.endTime ? new Date(s.endTime).getTime() - new Date(s.startTime).getTime() : timeNow - new Date(s.startTime).getTime();
      ...
      const durationStr = s.endTime ? `${hours}h ${minutes}m` : `${hours}h ${minutes}m ${seconds}s`;
      const showAvgFocus = s.averageFocusScore !== void 0 && s.averageFocusScore !== null && (s.averageFocusScore > 0 || s.endTime);
      return /* @__PURE__ */ jsxs(motion.div, { initial: {
        ...
        /* @__PURE__ */ jsxs("div", { className: "relative", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
            /* @__PURE__ */ jsxs("span", { className: `flex items-center gap-1.5 rounded-full border px-2.5 py-0.5 text-[10px] uppercase tracking-wider ${s.endTime ? "border-emerald-500/30 bg-emerald-500/10 text-emerald-400" : "border-danger/30 bg-danger/10 text-danger animate-pulse"}`, children: [
              !s.endTime && /* @__PURE__ */ jsx("span", { className: "h-1.5 w-1.5 rounded-full bg-danger animate-ping" }),
          ...
          /* @__PURE__ */ jsxs("h3", { className: "mt-4 font-display text-lg font-semibold leading-snug truncate", children: [
            "Session #",
            sessions.length - i,
            " (",
            s._id.slice(-6),
          ...
          /* @__PURE__ */ jsxs("div", { className: "mt-5 grid grid-cols-3 gap-2", children: [
            /* @__PURE__ */ jsx(Mini, { label: "Avg focus", value: showAvgFocus ? `${Math.round(s.averageFocusScore || 0)}%` : "--", tone: "emerald", icon: Brain }),
            /* @__PURE__ */ jsx(Mini, { label: "Study time", value: durationStr, tone: "gold", icon: Clock }),
            /* @__PURE__ */ jsx(Mini, { label: "Distractions", value: `${s.totalDistractions || 0}`, tone: "rose", icon: ShieldAlert })
          ] }),
          /* @__PURE__ */ jsx("div", { className: "mt-6 flex gap-2", children: s.endTime ? /* @__PURE__ */ jsxs("button", { onClick: () => downloadPDF(s), className: "inline-flex w-full items-center justify-center gap-2 rounded-xl bg-primary px-3 py-2.5 text-xs font-semibold text-primary-foreground glow-emerald hover:brightness-110", children: [
            /* @__PURE__ */ jsx(FileText, { className: "h-3.5 w-3.5" }),
            " PDF"
          ] }) : /* @__PURE__ */ jsx("button", { onClick: () => handleStopTrackingInReports(s._id), disabled: stoppingId === s._id, className: "inline-flex w-full items-center justify-center gap-2 rounded-xl bg-red-600 hover:bg-red-500 disabled:bg-red-800/50 disabled:cursor-not-allowed px-3 py-2.5 text-xs font-semibold text-white glow-red hover:brightness-110 transition-all", children: stoppingId === s._id ? /* @__PURE__ */ jsxs(Fragment, { children: [
            /* @__PURE__ */ jsx(Loader2, { className: "h-3.5 w-3.5 animate-spin" }),
            " Stopping..."
          ] }) : /* @__PURE__ */ jsx(Fragment, { children: "Stop Tracking" }) }) })
        ] })
      ] }, s._id);
    }) })
  ] });
...
function Mini({
  ...
  return /* @__PURE__ */ jsxs("div", { className: "rounded-xl border border-border bg-white/5 p-2 flex flex-col justify-between min-h-[64px]", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between text-[9px] uppercase tracking-wider text-muted-foreground gap-1", children: [
      /* @__PURE__ */ jsx("span", { className: "truncate", children: label }),
      Icon && /* @__PURE__ */ jsx(Icon, { className: "h-3.5 w-3.5 shrink-0 text-muted-foreground opacity-60" })
    ] }),
    /* @__PURE__ */ jsx("div", { className: `mt-1.5 font-display text-sm font-semibold truncate ${tone === "emerald" ? "text-gradient-emerald" : tone === "gold" ? "text-gradient-gold" : "text-gradient-rose"}`, children: value })
  ] });
}
export {
