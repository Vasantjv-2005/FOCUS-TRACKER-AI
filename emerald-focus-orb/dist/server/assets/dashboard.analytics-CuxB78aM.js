...
import { c as fetchSessionReport, b as fetchAllSessions } from "./api-CERjnBmU.js";
...
function Analytics() {
  ...
  const getLiveChartData = () => {
    ...
    return report.focusLogs.map((log) => ({
      t: new Date(log.createdAt).toLocaleTimeString([], {
        hour: "2-digit",
        minute: "2-digit",
        second: "2-digit"
      }),
  ...
  const getDayChartData = () => {
    const todaySessions = [...filteredSessions].reverse();
  ...
  const getWeekChartData = () => {
    ...
    for (let i = 6; i >= 0; i--) {
      ...
      d.setHours(0, 0, 0, 0);
      const nextDay = new Date(d.getTime() + 24 * 60 * 60 * 1e3);
      const daySessions = sessions.filter((s) => {
        const t = new Date(s.startTime).getTime();
        return t >= d.getTime() && t < nextDay.getTime();
      });
      const completed = daySessions.filter((s) => s.endTime && s.averageFocusScore > 0);
      const avg = completed.length > 0 ? Math.round(completed.reduce((sum, s) => sum + s.averageFocusScore, 0) / completed.length) : 0;
      data.push({
  ...
  const getDistributionData = () => {
    ...
    let reviewCount = 0;
    let breaksCount = 0;
    const list = activeTab === "live" ? report?.averageFocusScore ? [{
    ...
    return [{
      name: "Deep work",
      value: Math.round(deepWorkCount / total * 100),
      color: "#00A86B"
    }, {
      name: "Review",
      value: Math.round(reviewCount / total * 100),
      color: "#D4AF37"
    }, {
      name: "Practice",
      value: Math.round(practiceCount / total * 100),
      color: "#00695C"
    }, {
      name: "Breaks",
      value: Math.round(breaksCount / total * 100),
      color: "#B87333"
    }];
  };
  const renderTrendChart = () => {
    if (activeTab === "live") {
      ...
      if (data.length === 0) {
        return /* @__PURE__ */ jsx("div", { className: "flex h-64 items-center justify-center text-sm text-muted-foreground", children: "No live tracking session currently running." });
      }
      return /* @__PURE__ */ jsx(ResponsiveContainer, { width: "100%", height: 260, children: /* @__PURE__ */ jsxs(LineChart, { data, children: [
        /* @__PURE__ */ jsx(CartesianGrid, { stroke: "rgba(255,255,255,0.06)", vertical: false }),
        /* @__PURE__ */ jsx(XAxis, { dataKey: "t", stroke: "rgba(255,255,255,0.4)", fontSize: 11, axisLine: false, tickLine: false }),
        /* @__PURE__ */ jsx(YAxis, { stroke: "rgba(255,255,255,0.4)", fontSize: 11, axisLine: false, tickLine: false, domain: [0, 100] }),
    ...
    if (activeTab === "day") {
      ...
      if (data.length === 0) {
        return /* @__PURE__ */ jsx("div", { className: "flex h-64 items-center justify-center text-sm text-muted-foreground", children: "No study sessions recorded today." });
      }
      return /* @__PURE__ */ jsx(ResponsiveContainer, { width: "100%", height: 260, children: /* @__PURE__ */ jsxs(LineChart, { data, children: [
        /* @__PURE__ */ jsx(CartesianGrid, { stroke: "rgba(255,255,255,0.06)", vertical: false }),
        /* @__PURE__ */ jsx(XAxis, { dataKey: "name", stroke: "rgba(255,255,255,0.4)", fontSize: 11, axisLine: false, tickLine: false }),
        /* @__PURE__ */ jsx(YAxis, { stroke: "rgba(255,255,255,0.4)", fontSize: 11, axisLine: false, tickLine: false, domain: [0, 100] }),
        /* @__PURE__ */ jsx(Tooltip, { contentStyle: tooltipStyle }),
        /* @__PURE__ */ jsx(Line, { type: "monotone", dataKey: "score", stroke: "#00A86B", strokeWidth: 2.5, dot: {
          fill: "#D4AF37",
    ...
    if (activeTab === "week") {
      ...
      if (!hasData) {
        return /* @__PURE__ */ jsx("div", { className: "flex h-64 items-center justify-center text-sm text-muted-foreground", children: "No study sessions recorded in the last 7 days." });
      }
      return /* @__PURE__ */ jsx(ResponsiveContainer, { width: "100%", height: 260, children: /* @__PURE__ */ jsxs(BarChart, { data, children: [
    ...
    if (activeTab === "month") {
      ...
      const hasData = data.some((d) => d.score > 0);
      if (!hasData) {
        return /* @__PURE__ */ jsx("div", { className: "flex h-64 items-center justify-center text-sm text-muted-foreground", children: "No study sessions recorded in the last 30 days." });
      }
      return /* @__PURE__ */ jsx(ResponsiveContainer, { width: "100%", height: 260, children: /* @__PURE__ */ jsxs(LineChart, { data, children: [
        /* @__PURE__ */ jsx(CartesianGrid, { stroke: "rgba(255,255,255,0.06)", vertical: false }),
        /* @__PURE__ */ jsx(XAxis, { dataKey: "date", stroke: "rgba(255,255,255,0.4)", fontSize: 11, axisLine: false, tickLine: false, tickFormatter: (val, i) => i % 5 === 0 ? val : "" }),
        /* @__PURE__ */ jsx(YAxis, { stroke: "rgba(255,255,255,0.4)", fontSize: 11, axisLine: false, tickLine: false, domain: [0, 100] }),
        /* @__PURE__ */ jsx(Tooltip, { contentStyle: tooltipStyle }),
    ...
    if (activeTab === "year") {
      ...
      const hasData = data.some((d) => d.score > 0);
      if (!hasData) {
        return /* @__PURE__ */ jsx("div", { className: "flex h-64 items-center justify-center text-sm text-muted-foreground", children: "No study sessions recorded in the last 12 months." });
      }
      return /* @__PURE__ */ jsx(ResponsiveContainer, { width: "100%", height: 260, children: /* @__PURE__ */ jsxs(LineChart, { data, children: [
        /* @__PURE__ */ jsx(CartesianGrid, { stroke: "rgba(255,255,255,0.06)", vertical: false }),
        /* @__PURE__ */ jsx(XAxis, { dataKey: "month", stroke: "rgba(255,255,255,0.4)", fontSize: 11, axisLine: false, tickLine: false }),
        /* @__PURE__ */ jsx(YAxis, { stroke: "rgba(255,255,255,0.4)", fontSize: 11, axisLine: false, tickLine: false, domain: [0, 100] }),
        /* @__PURE__ */ jsx(Tooltip, { contentStyle: tooltipStyle }),
        /* @__PURE__ */ jsx(Line, { type: "monotone", dataKey: "score", stroke: "#00A86B", strokeWidth: 2.5, dot: {
          fill: "#D4AF37",
  ...
  const getTrendTitle = () => {
    switch (activeTab) {
      ...
      case "day":
        return "Today's focus trend";
      case "week":
        return "Weekly performance";
      case "month":
        return "Monthly improvement";
      case "year":
  ...
  return /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
    /* @__PURE__ */ jsxs("header", { className: "flex flex-wrap items-end justify-between gap-3", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "flex gap-1 rounded-xl border border-border bg-white/5 p-1 text-xs", children: tabs.map((tab) => /* @__PURE__ */ jsx("button", { onClick: () => setActiveTab(tab.id), className: `rounded-lg px-3 py-1.5 transition-all ${activeTab === tab.id ? "bg-primary/15 text-primary" : "text-muted-foreground hover:text-foreground"}`, children: tab.label }, tab.id)) })
    ] }),
    loading ? /* @__PURE__ */ jsxs("div", { className: "flex h-96 items-center justify-center text-muted-foreground", children: [
      /* @__PURE__ */ jsx(Loader2, { className: "mr-2 h-8 w-8 animate-spin" }),
      "Loading analytics..."
      ...
      /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-4 lg:grid-cols-4", children: [
        ...
        /* @__PURE__ */ jsx(MetricCard, { label: "Status", value: statusText, tone: "gold" })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 gap-6 lg:grid-cols-2", children: [
        /* @__PURE__ */ jsx(ChartCard, { title: getTrendTitle(), children: renderTrendChart() }),
        /* @__PURE__ */ jsx(ChartCard, { title: "Study time distribution", children: hasDistributionData ? /* @__PURE__ */ jsx(ResponsiveContainer, { width: "100%", height: 260, children: /* @__PURE__ */ jsxs(PieChart, { children: [
          /* @__PURE__ */ jsx(Pie, { data: distributionData, dataKey: "value", innerRadius: 60, outerRadius: 90, paddingAngle: 3, stroke: "none", children: distributionData.map((d) => /* @__PURE__ */ jsx(Cell, { fill: d.color }, d.name)) }),
          /* @__PURE__ */ jsx(Tooltip, { contentStyle: tooltipStyle }),
          /* @__PURE__ */ jsx(Legend, { wrapperStyle: {
            fontSize: 12,
            color: "#94A3B8"
          } })
        ] }) }) : /* @__PURE__ */ jsx("div", { className: "flex h-64 items-center justify-center text-sm text-muted-foreground", children: "No distribution data available for this timeframe." }) })
      ] })
    ] })
  ] });
}
