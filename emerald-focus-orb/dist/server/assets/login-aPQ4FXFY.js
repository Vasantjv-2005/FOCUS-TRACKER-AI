...
function Login() {
  return /* @__PURE__ */ jsxs("div", { className: "relative grid min-h-screen place-items-center px-4 py-10", children: [
    ...
    /* @__PURE__ */ jsxs(motion.div, { initial: {
      ...
      /* @__PURE__ */ jsx("div", { className: "mt-6 flex justify-center", children: /* @__PURE__ */ jsx(SignIn, { signUpUrl: "/signup", forceRedirectUrl: "/dashboard", fallbackRedirectUrl: "/dashboard", appearance: {
        variables: {
          colorPrimary: "#00A86B"
        }
      } }) }),
