...
function Login() {
  return /* @__PURE__ */ jsxs("div", { className: "relative grid min-h-screen place-items-center px-4 py-10", children: [
    ...
    /* @__PURE__ */ jsxs(motion.div, { initial: {
      ...
      /* @__PURE__ */ jsx("h1", { className: "font-display text-3xl font-semibold", children: "Welcome back" }),
      /* @__PURE__ */ jsx("p", { className: "mt-1 text-sm text-muted-foreground", children: "Use your Clerk account to continue your deep work streak." }),
      /* @__PURE__ */ jsx("div", { className: "mt-6 flex justify-center", children: /* @__PURE__ */ jsx(SignIn, { routing: "path", path: "/login", signUpUrl: "/signup", forceRedirectUrl: "/dashboard", fallbackRedirectUrl: "/dashboard", appearance: {
        variables: {
          colorPrimary: "#00A86B"
        }
      } }) }),
      /* @__PURE__ */ jsxs("p", { className: "mt-6 text-center text-sm text-muted-foreground", children: [
        "New here?",
        " ",
        /* @__PURE__ */ jsx(Link, { to: "/signup", className: "text-accent hover:underline", children: "Create an account" })
      ] })
    ] })
  ] });
}
