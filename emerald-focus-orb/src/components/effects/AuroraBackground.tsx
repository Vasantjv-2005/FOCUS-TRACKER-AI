export function AuroraBackground() {
  return (
    <div className="aurora-bg -z-10">
      <div className="absolute -top-40 -left-40 h-[42rem] w-[42rem] rounded-full bg-[radial-gradient(circle_at_center,oklch(0.7_0.17_158/0.45),transparent_60%)] blur-3xl animate-aurora" />
      <div
